<template>
  <div>
        ...
        <div class="row">
          ...
          <div class="col-lg-10 col-md-10 col-sm-10 mt-3 mb-1">
            <form @submit.prevent="onSearch" class="row g-3 align-items-center">
              ...
              <div class="col-md-3 mt-1 mb-1">
                <input v-model="searchForm.phone" type="text" inputmode="numeric" class="form-control form-control-sm"
          ...
          <table class="table table-bordered row-5" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              <tr v-for="user of users" :key="user.id">
                ...
                <td class="col-lg-3 col-md-3 col-sm-3">
                  <template v-if="editingUser?.id === user.id">
                    <input v-model="editingUser.phone" type="text" inputmode="numeric" class="form-control"
                ...
                <td class="col-lg-2 col-md-2 col-sm-2">
                  <template v-if="editingUser?.id === user.id">
                    <select v-model="editingUser.status" class="form-control" :class="{ 'is-invalid': errors.status }">
                      <option :value="UserStatus.Active">Active</option>
                      <option :value="UserStatus.Blocked">Blocked</option>
                    </select>
                  ...
                  <template v-else>
                    <span
                      :class="['status-label badge', user.status === UserStatus.Active ? 'btn-success' : 'btn-danger']">
    ...
    <UserCreate v-model="showCreateModal" @created="fetchUsers" />
  </div>
</template>
