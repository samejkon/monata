  ...
  <div class="container mt-5">
    ...
    <div class="col-lg-8">
        ...
        <div class="card-body p-4">
            <h3 class="mb-4 text-center">Update Service</h3>
            <form class="row g-3" @submit.prevent="handleUpdateSubmit">
            <div class="col-md-6">
            ...
            <div class="col-12 text-center mt-3">
                <button type="submit" class="btn btn-warning px-5 py-2">Update Service</button>
            </div>
            </form>
        </div>
        </div>
...
<script setup lang="ts">
  ...
  const { form, errors, handleUpdateSubmit, loadService } = useService();

  onMounted(() => {
    loadService(Number(route.params.id));
  });
</script>
