...
const addSelectedRoomsToBooking = () => {
  ...
  recalculateTotalPrice();
  toast.success(`Added ${roomsToAdd.length} room(s).`);
        ...
        <div class="modal-body">
          <form id="updateBookingForm" @submit.prevent="updateBooking">
            ...
            <div class="row g-3 mb-4">
              <div class="col-md-6">
                <label for="editTotalPrice" class="form-label">Total Amount</label>
            ...
            <div v-if="showRoomAvailabilitySection" id="roomAvailabilitySection"
              ...
              <h5 class="mb-3">Check Room Availability</h5>
              <div class="row g-3 mb-3">
                <div class="col-md-6">
                  ...
                  <FlatPickr v-model="searchCheckInTime" :config="flatpickrConfigGlobal" class="form-control"
                    placeholder="Select check-in date and time" id="searchCheckInTimeInput" />
                </div>
                <div class="col-md-6">
                  ...
                  <FlatPickr v-model="searchCheckOutTime" :config="flatpickrConfigGlobal" class="form-control"
                    placeholder="Select check-out date and time" id="searchCheckOutTimeInput" />
                </div>
              </div>
              <div class="mb-3">
