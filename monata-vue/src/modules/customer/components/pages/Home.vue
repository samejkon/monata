<template>
  <section class="section-about container">
    ...
    <div class="section-about-end">
      ...
      <div class="about-item">
        <img class="item-img item-img-bot" src="@/modules/customer/assets/img/about/about_2.png" alt="about us" srcset="" />
      </div>
    </div>
  </section>
      ...
      <div v-for="offer in roomTypeOffers" :key="offer.id" class="offer">
        ...
        <div class="offer-info">
          ...
          <ul class="offer-descriptions gray">
            <li class="offer-description" v-for="property in offer.properties" :key="property.property_id">{{ property.name }}: {{ property.value }}</li>
          </ul>
  ...
  <section class="container section-food">
  ...
  <section class="section-qa container">
